...
```bash
gh issue view <issue-number> --repo okou-ai/okou
```
...
curl -sL https://raw.githubusercontent.com/okou-ai/freeze-dry-bundle/main/freeze-dry-bundle.js | agent-browser eval --stdin
```
...
git clone https://github.com/okou-ai/ui-innovate.git /tmp/ui-innovate-repo
...
The GitHub Pages base URL is: `https://okou-ai.github.io/ui-innovate/`

```bash
gh issue comment <issue-number> --repo okou-ai/okou --body "$(cat <<'EOF'
## UI Design Exploration

I've created 3 design variants for this issue. You can preview them here:

**[View all variants →](https://okou-ai.github.io/ui-innovate/issues/<issue-number>/)**

### Variant A — <Title>
<One-line description of the approach>
[Preview](https://okou-ai.github.io/ui-innovate/issues/<issue-number>/variant-a/<file>.html)

### Variant B — <Title>
<One-line description of the approach>
[Preview](https://okou-ai.github.io/ui-innovate/issues/<issue-number>/variant-b/<file>.html)

### Variant C — <Title>
<One-line description of the approach>
[Preview](https://okou-ai.github.io/ui-innovate/issues/<issue-number>/variant-c/<file>.html)

---
<sub>Baselines and variants generated with [freeze-dry](https://github.com/okou-ai/freeze-dry-bundle) · [Source](https://github.com/okou-ai/ui-innovate/tree/main/issues/<issue-number>)</sub>
EOF
)"
```
...
📄 Index: https://okou-ai.github.io/ui-innovate/issues/<issue-number>/
