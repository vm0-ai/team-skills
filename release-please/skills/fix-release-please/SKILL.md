...
description: Fix bugs in the forked release-please ecosystem (okou-ai/release-please + okou-ai/release-please-action)
context: fork
---
...
|------|---------|--------|------|
| `okou-ai/release-please` | `googleapis/release-please` | `vm0` | Core library (TypeScript/Node) |
| `okou-ai/release-please-action` | `googleapis/release-please-action` | `vm0` | GitHub Action wrapping the core library |

- `.github/workflows/release-please.yml` uses `okou-ai/release-please-action@vm0`
- The action's `package.json` has `"release-please": "github:okou-ai/release-please#vm0"`
...
git clone https://github.com/okou-ai/release-please.git
git clone https://github.com/okou-ai/release-please-action.git
cd /tmp/release-please && git config user.email "noreply@vm0.ai" && git config user.name "okou-ai"
cd /tmp/release-please-action && git config user.email "noreply@vm0.ai" && git config user.name "okou-ai"
```
